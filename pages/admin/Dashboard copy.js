...
import SidebarLinkGroup from "./SidebarLinkGroup.js";
  ...
  return (
    <div>
      ...
      <div
        ...
        lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar
      ...
      >
        ...
        <div className="flex justify-between pr-3 mb-10 sm:px-2">
          ...
          {/* Logo */}
          <NavLink end to="/manage-admin" className="block">
                      ...
                      <div className="">
                        <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            ...
                            >
                              <span className="text-xl font-medium text-color-red">
                               บุคคล
                              </span>
                            </NavLink>
                          </li>
                          ...
                          <li className="mb-1 last:mb-0">
                            ...
                            >
                              <span className="text-xl font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                                ภาพสไลด์
                              </span>
                            </NavLink>
                          </li>
                      ...
                      >
                        <div className="flex items-center justify-between text-xl">
                          <div className="flex items-center">
                            ...
                            <span className="ml-3 font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                              หมวดหมู่สินค้า
                            </span>
                          </div>
                          {/* Icon */}
              ...
              >
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="ml-3 text-xl font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                      รายการสั่งซื้อ
                    </span>
                  </div>
                </NavLink>
