      ...
      <div className="grid md:grid-cols-5 lg:grid-cols-5">
        ...
        <div>
          <div>
            {!selectedImage ? (
              ...
              <>
            <img
                  src={`http://localhost:4000/${selectedImage.filePath}`}
                  className="md:max-w-[400px] md:h-96 lg:max-w-[500px] lg:h-64 mx-auto "
                />
              </>
            )}
          </div>

          {/* {selectedImage.filePath?("not null "):null} */}
        ...
        <div className="w-64 flex flex-col gap-6 ml-64">
          <div className="title w-[341px] flex flex-col gap-4">
            ...
            <div className=" text-xl  ">แบรนด์ : <b className="  text-gray-500 ">{brand}</b></div>
            <div className="  text-xl ">ยอดขาย :<b className="  text-gray-500 "> {sold}</b></div>
          </div>
          ...
          {product &&
            [product].map((p, index) => (
              <div key={index} className=" flex justify-between mr-32">
                <div className="flex ">
                  <button
                    className="w-32 p-2 mr-5 mb-5 text-center text-white bg-red-700 border rounded-md hover:bg-red-600 hover:text-white hover:border-transparent"
                ...
                <div className="flex justify-center">
                  <Link to={`/`}>
                    <button className="w-32 p-2 mb-5 text-center text-white bg-green-500 border rounded-md hover:bg-green-600 hover:text-white hover:border-transparent">
                      หน้าแรก
                    </button>
                  </Link>
                </div>
